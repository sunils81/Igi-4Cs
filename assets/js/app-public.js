...
const quizQuestions = [
    ...
    { id:6,  question:"Which clarity grade indicates a diamond completely free of inclusions AND blemishes under 10x magnification?", options:["VVS1","IF (Internally Flawless)","FL (Flawless)","VS1"],              correct:2 },
    ...
    { id:11, question:"Which of the following is NOT one of the 4Cs of diamonds?",                                        options:["Cut","Clarity","Carat","Certification"],                                              correct:3 },
    ...
    { id:15, question:"What is 'Fire' in a diamond?",                                                                    options:["The sparkle seen when the diamond is moved","The dispersion of white light into spectral colors","The surface reflection of the stone","The overall brightness of the stone"], correct:1 },
    { id:16, question:"What does 'Scintillation' refer to in a diamond?",                                                 options:["The overall whiteness of the stone","The color saturation","The pattern of light and dark areas seen when the diamond is moved","The depth percentage"], correct:2 },
    ...
    { id:19, question:"Which of the following are considered 'Fancy Cut' diamonds?",                                      options:["Round Brilliant only","Oval, Marquise, Princess, Pear","Only square shapes","Only elongated shapes"], correct:1 },
    ...
    { id:22, question:"Which of the 4Cs has the single greatest influence on a diamond's total price?",                   options:["Clarity","Color","Cut","Carat Weight"],                                                  correct:3 },
    { id:23, question:"A diamond graded 'SI2' in clarity — how are the inclusions typically described?",                  options:["Not visible under any magnification","Visible under 10x magnification; may occasionally be eye-visible","Always clearly visible to the naked eye","Only visible under 100x magnification"], correct:1 },
